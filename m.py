...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;33mV\033[1;34mu\033[1;35mi \033[1;32mL\033[1;33mò\033[1;34mn\033[1;35mg \033[1;36mC\033[1;33mh\033[1;34mờ {trang}[\033[1;35m.....""]""["+str(o)+"]""    ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;31mV\033[1;32mu\033[1;33mi \033[1;34mL\033[1;35mò\033[1;31mn\033[1;32mg \033[1;33mC\033[1;32mh\033[1;35mờ {trang}[\033[1;33m•{trang}....""]"f"{trang}[{xanhnhat}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;32mV\033[1;33mu\033[1;34mi \033[1;35mL\033[1;36mò\033[1;33mn\033[1;34mg \033[1;35mC\033[1;31mh\033[1;32mờ {trang}[\033[1;35m••{trang}...""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;31mV\033[1;33mu\033[1;35mi \033[1;33mL\033[1;31mò\033[1;32mn\033[1;34mg \033[1;36mC\033[1;35mh\033[1;31mờ {trang}[\033[1;32m•••{trang}..""]"f"{trang}[{do}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;32mV\033[1;34mu\033[1;36mi \033[1;32mL\033[1;34mò\033[1;31mn\033[1;35mg \033[1;33mC\033[1;36mh\033[1;35mờ {trang}[\033[1;38m••••{trang}.""]"f"{trang}[{tim}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}laminhloi{trang}] \033[1;31mV\033[1;34mu\033[1;36mi \033[1;32mL\033[1;34mò\033[1;32mn\033[1;35mg \033[1;36mC\033[1;34mh\033[1;32mờ {trang}[\033[1;33m•••••{trang}""]"f"{trang}[{vang}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(0.1)
        print(f"{trang}[{xanhnhat}La Minh Lợi {trang}] \033[1;31mV\033[1;34mu\033[1;36mi \033[1;32mL\033[1;34mò\033[1;32mn\033[1;35mg \033[1;36mC\033[1;34mh\033[1;32mờ {trang}[\033[1;33m•••••{trang}""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')

chontool = """
  \033[1;33m\033[1m ☆
 \033[32;5;245m\033[1m\033[38;5;39m Lưu ý để delay 8-12 để hạn chế bị mõm sớm
 \033[32;5;245m\033[1m\033[38;5;39m La Minh Lợi yêu bạn vcl ღ
 \033[32;5;245m\033[1m\033[38;5;39m La Minh Lợi Đz Vcl
 \033[1;31m\033[1m\033[1m Facebook: https://www.facebook.com/minhhloiikhibenanhemthayd
"""

clear()
runbanner(chontool)
idcanspam=input(f'\033[1;97m[\033[1;31m⁂\033[1;97m] {xanhnhat}Nhập id box cần treo :{vang} ')
file_list = []
while True:
    ck=input(f'\033[1;97m[\033[1;31m⁂\033[1;97m] {xanhnhat}Nhập cookie acc treo Cho Lợi :{vang} ')
    try:
...
if lol.lower() == "y":
      ...
      while True:
        stt += 1
        name_files=input(f'\033[1;97m[\033[1;31m⁂\033[1;97m] {xanhnhat}Nhập file chứa nội dung thứ {stt} của bạn (ex: nd.txt) :{vang} ')
